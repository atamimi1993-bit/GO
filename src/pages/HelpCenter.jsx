...
const DEFAULT_FAQ = {
  customer: [
    ...
    { title: 'How is the price calculated?', content: 'Your price is based on: total item weight, round-trip distance, truck fuel cost, local tax rate, and a 25% GO platform fee. The driver earns a rate based on truck size, distance, and weight. You see the full breakdown before confirming.' },
  ...
  driver: [
    ...
    { title: 'How do I get paid?', content: 'You earn a payout for each completed job based on your truck size, distance, and item weight. View your earnings on the Payouts page in your Driver Hub.' },
  ...
  general: [
    ...
    { title: 'How does GO make money?', content: 'GO charges a 25% platform fee on each move, which is included in your quote. This covers platform operations, driver verification, dispute resolution, and customer support.' },
  ],
};
