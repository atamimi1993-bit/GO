    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed md:!bottom-6 right-20 z-50 w-14 h-14 rounded-full bg-amber-500 text-white shadow-lg hover:scale-105 transition-transform flex items-center justify-center"
        >
          <Wrench size={24} />
