    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed md:!bottom-6 right-[4.5rem] z-50 w-14 h-14 rounded-full bg-primary text-primary-foreground shadow-lg hover:scale-105 transition-transform flex items-center justify-center"
        >
