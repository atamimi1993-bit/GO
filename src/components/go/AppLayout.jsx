...
import { Home, Package, Truck, HelpCircle, User, LogOut, Warehouse, ShieldCheck, Navigation, DollarSign, Trophy, TrendingUp, Car, FileText, CalendarClock, Crown, Target } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Lead Market', path: '/lead-marketplace', icon: Target, driverOnly: true },
  { label: 'Upgrade', path: '/driver-upgrade', icon: Crown, driverOnly: true },
